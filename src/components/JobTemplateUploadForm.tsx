...
interface JobTemplateUploadFormProps {
    onItemAdded?: () => void;
}

const JobTemplateUploadForm = ({ onItemAdded }: JobTemplateUploadFormProps) => {
    ...
    const uploadFile = async () => {
        ...
        try {
            ...
            const res = await api.post('/job-template-upload-url', {
                fileName: file.name,
...
export default JobTemplateUploadForm;
